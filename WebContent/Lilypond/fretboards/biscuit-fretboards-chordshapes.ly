...
\addChordShape #'rootDimChordShape #biscuitTuning #"3-4;2-1-(;2-1-);3-5;"	% Bes:dim
...
\addChordShape #'firstMin7ChordShape #biscuitTuning #"2-1;5-1;4-4;x-x;"		% fis':min7
\addChordShape #'firstDimChordShape #biscuitTuning #"2-2-(;1-1;4-5;x-x;"	% fis':dim
